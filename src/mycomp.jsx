...
// function Fake() {
//   return (<div style={{display:"flex",gap:"10px",background:"aqua",flexWrap:"wrap",justifyContent:"center",}}>
// {products.map((a,b)=>{
//     return(
//         <div style={{display:"flex",flexDirection:"column",width:"350px",background:"orange",}}>
        
//         <img src={a.image} alt={a.price} style={{height:"120px"}}/>
//         <h4>{a.title}</h4>
//         <h1>{a.price}</h1>
//         </div>
//     )
                    ...
                    {products.map((a,b)=>{
                        ...
                        return(
                            <tr key={b}>
                                ...
                                {/* <td><img src={a.image} alt={a.title} style={{height:"20vh"}}/></td> */}
                            </tr>
                        ) 
                    })}
                </tbody>
